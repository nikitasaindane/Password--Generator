...
//assume length of password 10 in starting
//initally checked the uppercase box
//colour of strength will be grey
let password = "";
...
//set passwordLength
//according to slider length will be set
//refelct apsswordword length to ui
function handleslider() {
  inputslider.value = passwordLength;
  //initial length will be 10
